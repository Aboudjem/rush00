...
<br />';
echo '<table border="1px">
    <form style="display: flex; flex-direction: column;text-align:center;" action="modif_article.php" method="post" style="padding-right: 10px;"  enctype="multipart/form-data">
<tr>
    <td style="height: 50px">
        <span style="padding-right: 4px;" class="name_cat">Categorie:</span>
    </td>
    ...
    <input style="font-size: 30px; display:flex;" type="submit" name="submit" value="Modifier"/>
    </form>'
?>